...
internal class AllPastBookingSummariesQueryHandler(
    ApplicationDbContext dbContext
) : IQueryHandler<AllPastBookingSummariesQuery, IPaginatedResult<BookingSummary>>
{
    public async Task<IPaginatedResult<BookingSummary>> ExecuteAsync(
        AllPastBookingSummariesQuery query,
