...
internal class AllPastPropertyBookingsQueryHandler(
    ApplicationDbContext dbContext
) : IQueryHandler<AllPastPropertyBookingsQuery, IPaginatedResult<PropertyBooking>>
{
    public async Task<IPaginatedResult<PropertyBooking>> ExecuteAsync(
        AllPastPropertyBookingsQuery query,
